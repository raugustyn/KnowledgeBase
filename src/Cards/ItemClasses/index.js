...
let registry = new Registry([
    ...
    new RegistryItem("Checklists",  DateTimeEditor,     null, "Checklist", "", true, new SectionButtonDef(null, "\uE913")),
    new RegistryItem("Properties",  DateTimeEditor,     null, "Properties", "", false, new SectionButtonDef(null, "\uE93B")),
